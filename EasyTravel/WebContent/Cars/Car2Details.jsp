...
<div class="clearfix">
    <table class="box1" style="background-color:#bbb">
      ...
      <div class="box2" >
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRL22Pfx7w6RNXVmfhli_EXTkLxVDfwWmz3bg&usqp=CAU">
  </div>
   </div>
   <tfoot>
        <tr>
<td colspan="3"><button><a href="Book car2.jsp">Book Now</a></button></td>
