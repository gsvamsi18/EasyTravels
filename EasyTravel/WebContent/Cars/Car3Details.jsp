...
<div class="clearfix">
    <table class="box1" style="background-color:#bbb">
      ...
      <div class="box2" >
    <img idth="400" height="200" src="https://imgd.aeplcdn.com/0x0/n/cw/ec/41406/bmw-8-series-right-front-three-quarter8.jpeg">
  </div>
   </div>
   <tfoot>
        <tr>
<td colspan="3"><button><a href="Book car3.jsp">Book Now</a></button></td>
