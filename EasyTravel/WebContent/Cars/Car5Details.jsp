    ...
    <table class="box1" style="background-color:#bbb">
      <caption>Details of Car</caption>
        ...
        <tr>
          ...
          <td scope="col">Mercedes C Class</td>
        </tr>
      ...
      <div class="box2" >
    <img idth="400" height="200" src="https://imgd.aeplcdn.com/1200x900/cw/ec/36861/MercedesBenz-CClass-Cabriolet-Exterior-139428.jpg?wm=0&q=85">
  </div>
   </div>
   <tfoot>
        <tr>
<td colspan="3"><button><a href="Book car5.jsp">Book Now</a></button></td>
