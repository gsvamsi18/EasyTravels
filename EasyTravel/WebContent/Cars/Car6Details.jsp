...
<div class="clearfix">
    <table class="box1" style="background-color:#bbb">
      ...
      <div class="box2" >
    <img idth="400" height="200" src="https://images-na.ssl-images-amazon.com/images/I/61URAREN1zL._SL1500_.jpg">
  </div>
   </div>
   <tfoot>
        <tr>
<td colspan="3"><button><a href="Book car6.jsp">Book Now</a></button></td>
