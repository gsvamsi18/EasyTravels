    ...
    <table class="box1" style="background-color:#bbb">
      <caption>Details of Car</caption>
        ...
        <tr>
          ...
          <td scope="col">Bowler Bulldog</td>
        </tr>
      ...
      <div class="box2" >
    <img idth="400" height="200" src="https://cf2.s3.souqcdn.com/item/2016/12/12/12/00/67/79/item_XL_12006779_17982922.jpg">
  </div>
   </div>
   <tfoot>
        <tr>
<td colspan="3"><button><a href="Book car8.jsp">Book Now</a></button></td>
