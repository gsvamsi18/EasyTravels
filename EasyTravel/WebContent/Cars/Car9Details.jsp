...
<div class="clearfix">
    <table class="box1" style="background-color:#bbb">
      ...
      <div class="box2" >
    <img idth="400" height="200" src="https://img.favcars.com/maybach/zeppelin/maybach_zeppelin_1934_photos_1_b.jpg">
  </div>
   </div>
   <tfoot>
        <tr>
<td colspan="3"><button><a href="Book car9.jsp">Book Now</a></button></td>
